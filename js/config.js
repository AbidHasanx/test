...
window.CFG = (function () {
  ...
  const PROVIDERS = {
    gemini: {
      ...
      // ⚠️ ২০২৬-এর কারেন্ট মডেল — gemini-2.x নতুন ইউজারদের জন্য বন্ধ
      models: [
        'gemini-3.8-flash',
        'gemini-3.7-flash',
        'gemini-3.6-flash',
      ...
      freeModels: ['gemini-3.8-flash', 'gemini-3.7-flash', 'gemini-3.6-flash', 'gemini-3.5-flash', 'gemini-3.5-flash-lite', 'gemini-3.1-flash-lite']
    },
    openrouter: {
      id: 'openrouter',
      name: 'OpenRouter',
